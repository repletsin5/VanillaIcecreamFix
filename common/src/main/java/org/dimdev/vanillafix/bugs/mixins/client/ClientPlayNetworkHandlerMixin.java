...
public class ClientPlayNetworkHandlerMixin {
	...
	@ModifyArg(method = "startWorldLoading", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/MinecraftClient;setScreen(Lnet/minecraft/client/gui/screen/Screen;)V"))
